...
const IG_IDENTIFIERS = {
    ICH_ECTD_V4_IG: {
        root: "2.16.840.1.113883.3.989.2.2.1.11.5",
        name: "ICH eCTD v4.0 IG v1.5",
    },
    USFDA_ECTD_V4_IG: {
        root: "2.16.840.1.113883.3.989.5.1.2.2.1.18.7",
...
const APPLICATION_TYPES = {
    NDA: {
        code: "us_application_type_1",
        codeSystem: CODE_SYSTEMS.US_APPLICATION_TYPES,
    },
    ANDA: {
        code: "us_application_type_2",
        codeSystem: CODE_SYSTEMS.US_APPLICATION_TYPES,
    },
    BLA: {
        code: "us_application_type_3",
        codeSystem: CODE_SYSTEMS.US_APPLICATION_TYPES,
    },
    IND: {
        code: "us_application_type_4",
        codeSystem: CODE_SYSTEMS.US_APPLICATION_TYPES,
    },
    DMF: {
        code: "us_application_type_5",
        codeSystem: CODE_SYSTEMS.US_APPLICATION_TYPES,
    },
};
...
const SUBMISSION_TYPES = {
    original: {
        code: "us_submission_type_1",
        codeSystem: CODE_SYSTEMS.US_SUBMISSION_TYPES,
    },
    amendment: {
        code: "us_submission_type_2",
        codeSystem: CODE_SYSTEMS.US_SUBMISSION_TYPES,
    },
    supplement: {
        code: "us_submission_type_3",
        codeSystem: CODE_SYSTEMS.US_SUBMISSION_TYPES,
    },
    annual_report: {
        code: "us_submission_type_4",
        codeSystem: CODE_SYSTEMS.US_SUBMISSION_TYPES,
    },
};
...
const SUBMISSION_UNIT_TYPES = {
    initial: {
        code: "us_submission_unit_type_3",
        codeSystem: CODE_SYSTEMS.US_SUBMISSION_UNIT_TYPES,
    },
    amendment: {
        code: "us_submission_unit_type_4",
        codeSystem: CODE_SYSTEMS.US_SUBMISSION_UNIT_TYPES,
    },
};
...
const CONTACT_TYPES = {
    regulatory: {
        code: "us_submission_contact_type_1",
        codeSystem: CODE_SYSTEMS.US_SUBMISSION_CONTACT_TYPES,
    },
    technical: {
        code: "us_submission_contact_type_2",
        codeSystem: CODE_SYSTEMS.US_SUBMISSION_CONTACT_TYPES,
    },
};
...
const KEYWORD_TYPES = {
    manufacturer: {
        code: "ich_keyword_type_3",
        codeSystem: CODE_SYSTEMS.ICH_KEYWORD_TYPES,
    },
    productName: {
        code: "ich_keyword_type_4",
        codeSystem: CODE_SYSTEMS.ICH_KEYWORD_TYPES,
    },
    studyId: {
        code: "ich_keyword_type_8",
        codeSystem: CODE_SYSTEMS.ICH_KEYWORD_TYPES,
    },
};
...
const US_KEYWORD_DEFINITION_TYPES = {
    materialId: {
        code: "us_keyword_definition_type_1",
        codeSystem: CODE_SYSTEMS.US_KEYWORD_DEFINITION_TYPES,
    },
    issueDate: {
        code: "us_keyword_definition_type_2",
        codeSystem: CODE_SYSTEMS.US_KEYWORD_DEFINITION_TYPES,
    },
};
...
const DOCUMENT_TYPES = {
    study_report: {
        code: "ich_document_type_4",
        codeSystem: CODE_SYSTEMS.ICH_DOCUMENT_TYPES,
    },
    sdtm_define: {
        code: "ich_document_type_48",
        codeSystem: CODE_SYSTEMS.ICH_DOCUMENT_TYPES,
    },
    adam_define: {
        code: "ich_document_type_53",
        codeSystem: CODE_SYSTEMS.ICH_DOCUMENT_TYPES,
    },
    sdtm_dataset: {
        code: "ich_document_type_71",
        codeSystem: CODE_SYSTEMS.ICH_DOCUMENT_TYPES,
    },
    adam_dataset: {
        code: "ich_document_type_73",
        codeSystem: CODE_SYSTEMS.ICH_DOCUMENT_TYPES,
    },
};
...
const US_CTD_SECTIONS = {
    "m1.1": {
        code: "us_1.1",
        codeSystem: CODE_SYSTEMS.US_CTD_SECTIONS,
        name: "Forms",
    },
    "m1.2": {
        code: "us_1.2",
...
const ICH_CTD_SECTIONS = {
    ...
    "m2.2": {
        code: "ich_2.2",
        codeSystem: CODE_SYSTEMS.ICH_CTD_SECTIONS,
        name: "Introduction",
    },
    "m2.3": {
        code: "ich_2.3",
    ...
    "m3.2.p.2.2": {
        code: "ich_3.2.p.2.2",
        codeSystem: CODE_SYSTEMS.ICH_CTD_SECTIONS,
        name: "Drug Product Description and Composition",
    },
    "m3.2.a": {
        code: "ich_3.2.a",
        codeSystem: CODE_SYSTEMS.ICH_CTD_SECTIONS,
    ...
    "m5.2": {
        code: "ich_5.2",
        codeSystem: CODE_SYSTEMS.ICH_CTD_SECTIONS,
        name: "Tabular Listing of All Clinical Studies",
    },
    "m5.3.1.1": {
        code: "ich_5.3.1.1",
        codeSystem: CODE_SYSTEMS.ICH_CTD_SECTIONS,
    ...
    "m5.3.1.2": {
        code: "ich_5.3.1.2",
        codeSystem: CODE_SYSTEMS.ICH_CTD_SECTIONS,
        name: "Comparative BA/BE Studies",
    },
    "m5.3.3.1": {
        code: "ich_5.3.3.1",
        codeSystem: CODE_SYSTEMS.ICH_CTD_SECTIONS,
        name: "Controlled Clinical Studies",
    },
    "m5.3.5.1": {
        code: "ich_5.3.5.1",
        codeSystem: CODE_SYSTEMS.ICH_CTD_SECTIONS,
        name: "Efficacy and Safety Studies",
    },
    "m5.3.5.3": {
        code: "ich_5.3.5.3",
        codeSystem: CODE_SYSTEMS.ICH_CTD_SECTIONS,
        name: "Reports of Analyses of Data",
    },
};
