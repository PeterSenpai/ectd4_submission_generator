  ...
  properties: {
    ...
    submission: {
      ...
      properties: {
        type: {
          type: 'string',
          enum: ['original', 'amendment', 'supplement', 'annual_report'],
  ...
  $defs: {
    ...
    document: {
      ...
      properties: {
        ...
        type: {
          type: 'string',
          description: 'Document type (e.g., 356h, cover, bioavailability)'
        },
        title: {
          type: 'string',
          minLength: 1,
        ...
        replacesId: {
          type: 'string',
          description: 'UUID of contextOfUse being replaced (required for replace operation)'
        },
        filePath: {
          type: 'string',
          description: 'Path to existing file (optional, will generate placeholder if not provided)'
        },
        keywordRefs: {
          type: 'array',
          items: {
    ...
    keyword: {
      ...
      properties: {
        type: {
          type: 'string',
          enum: ['studyId', 'productName', 'manufacturer', 'materialId', 'issueDate'],
...
function getDefaultConfig() {
  return {
    ...
    documents: [
      ...
      { module: 'm3', type: 'product_info', title: 'Product Information' },
      { module: 'm5', type: 'bioavailability', title: 'Bioavailability Study Report' }
    ],
    keywords: [
      {
        type: 'studyId',
