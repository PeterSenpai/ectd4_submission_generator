                    ...
                    item: [
                        {
                            ...
                            "@_identifierName":
                                IG_IDENTIFIERS.ICH_ECTD_V4_IG.name,
                        },
                        {
                            "@_root": IG_IDENTIFIERS.USFDA_ECTD_V4_IG.root,
                            "@_identifierName":
                                IG_IDENTIFIERS.USFDA_ECTD_V4_IG.name,
                        },
                    ],
                },
            },
 ...
 */
function buildContactParty(
    contact,
    contactId,
    contactType,
    contactTypeCodeSystem
) {
    const telecomItems = [];
    ...
    const nameParts = [{ "@_type": "GIV", "@_value": contact.firstName }];

    if (contact.middleName) {
        nameParts.push({
            "@_type": "GIV",
            "@_value": contact.middleName,
            "@_qualifier": "MID",
        });
    }
...
function buildContextOfUse(options) {
    ...
    if (
        options.lifecycle &&
        options.lifecycle.operation === "replace" &&
        options.lifecycle.replacesId
    ) {
